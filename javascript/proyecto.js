const comprarProductos = () => {
    ...
    do {
        producto = prompt ("¿Querés comprar sillas, mesas o ambos?", "Ej: ambos");
    ...
    seguirComprando = confirm("¿Queres ampliar aun mas tu comedor?");
...
const calcularEnvio = (totalCompra) => {
    ...
    if (tieneEnvioADomicilio && totalCompra >= 16000) {
      alert("Tenés bonificamos el envio. El total de tu compra es $" + totalCompra);
    } else if (tieneEnvioADomicilio && totalCompra < 16000 && totalCompra !== 0) {
      totalCompra += 700;
